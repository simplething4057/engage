...
7. [시작하기](#7.시작하기)
8. [사용 흐름](#8.사용-흐름)
9. [AI 설계 원칙](#9.ai-설계-원칙)
10. [성공 지표 (KPI)](#10.성공-지표-kpi)
11. [개발 로드맵](#11.개발-로드맵)
12. [보완이 필요한 사항](#12.보완이-필요한-사항)
13. [라이선스](#13.라이선스)
...
<video src="docs/아맘때 - 상담 예약 - Chrome 2026-06-02 13-15-23.mp4" controls width="100%"></video>

> GitHub에서 영상이 재생되지 않는 경우 [`docs/` 폴더](docs/)에서 직접 파일을 열어 확인하세요.
