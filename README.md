...
📹 **[![데모 영상](docs/아맘때%20-%20상담%20예약%20-%20Chrome%202026-06-02%2013-15-23.mp4)**(https://youtu.be/srBBJxiPVWc)]

> GitHub에서 영상을 README에 인라인으로 표시하려면 GitHub 에디터에서 영상 파일을 직접 드래그&드롭으로 업로드하면 CDN 링크가 자동 생성됩니다.
